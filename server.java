...
public class HTTPServer implements Runnable{
    ...
    private void parseRequest() {
        ...
        if(input.split("\n")[0].contains("GET")) handleRequest("GET", linkRequested);
        // else if(input.split("\n")[0].contains("POST")) handleRequest("POST", linkRequested, os);
        else if(input.split("\n")[0].contains("PUT")) handleRequest("PUT", linkRequested);
        else if(input.split("\n")[0].contains("DELETE")) handleRequest("DELETE", linkRequested);
    }
    ...
    private String getContentType(String linkRequested){
        if(linkRequested.endsWith("htm") || linkRequested.endsWith("html")) return "text/html";
