...
// How does our server handle requests of varying sizes (i.e. simple HTML pages vs pages loaded with JS)
// Have a mix of clients that make big or small requests, and requests with low or high frequency. 
// For example, there will be a client making many small requests, or a client making a very large request. 
